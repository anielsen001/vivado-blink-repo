...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_pins blink_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK]
  connect_bd_net -net blink_0_output [get_bd_ports led] [get_bd_pins blink_0/output]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins blink_0/reset] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
